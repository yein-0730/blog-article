      ...
      sections: {
        ...
        items: {
          ...
          properties: {
            ...
            keyPoint: { type: "string", description: "핵심 메시지 1문장" },
          },
    ...
    properties: {
      ...
      seo: {
        ...
        properties: {
          ...
          aeoTips: { type: "array", items: { type: "string" } },
          geoTips: { type: "array", items: { type: "string" } },
        },
        required: ["metaTitle", "metaDesc", "primaryKeyword", "secondaryKeywords", "aeoTips", "geoTips"],
      },
      visuals: {
        type: "array",
        items: {
      ...
      async start(controller) {
        ...
        try {
          ...
          const metaPromise = client.messages.create({
            ...
            max_tokens: 2000,
            temperature: 0.7,
            system: "당신은 B2B 교육업 SEO/AEO/GEO 전문가입니다.",
            tools: [META_TOOL],
          ...
          const merged = { ...articleData, ...metaData };
